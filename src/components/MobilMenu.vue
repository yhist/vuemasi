    ...
    <div class="mb-wrap">
      ...
      <div class="mb-sns">
        <ul class="mb-sns-list clearfix">
          <li><a href="#"><img v-bind:src="require('@/assets/images/sns_blog.png')" alt="블로그"></a></li>
          <li><a href="#"><img v-bind:src="require('@/assets/images/sns_insta.png')" alt="인스타"></a></li>
          <li><a href="#"><img v-bind:src="require('@/assets/images/sns_facebook.png')" alt="페이스북"></a></li>
        </ul>
      </div>
      <ul class="mb-menu">
